...
<div
	class="responsive-container w-full rounded-[11px] border-2 border-[--accent-widget-border] bg-[--accent-widget] px-5 py-4 md:px-7 md:py-5 font-montserrat dark:text-white"
>
